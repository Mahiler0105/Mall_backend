...
class PaymentService {
  ...
  async mercadoPago(entity) {
    ...
    try {
      const response = await _mercadopago.default.preferences.create(preference);
  ...
  async createUserMP() {
    ...
    try {
      ...
      // });
      const response = await _mercadopago.default.customers.create({
        email: "oleic.tefa@gmail.com",
        ...
        default_address: "Home" //     default_card: '00389801314394792244',
  ...
  async test() {
    return this.getOrder(); // return this.createPreference()
  }
  ...
  async createCustomer(entity, retries = 0) {
    ...
    entity = {
      ...
      description: "LerietMall-customer" //     default_card: '00389801314394792244',
      // address: {
      //      zip_code: "",
      //      street_name: "",
      //      street_number: "",
    ...
    try {
      return await _mercadopago.default.customers.create(entity);
    } catch (err) {
  ...
  async searchCustomers(entity, retries = 0) {
    entity = {
      email: "oleic.tefa@gmail.com" // first_name: "Benjamin Andre",
      // last_name: "Valdivia Navarrete",
      // identification: "",
      // description: "",
    ...
    try {
      return await _mercadopago.default.customers.search(entity);
    } catch (err) {
  ...
  async getCustomer(entity, retries = 0) {
    ...
    try {
      return await _mercadopago.default.customers.get(entity);
    } catch (err) {
  ...
  async updateCustomer(entity, retries = 0) {
    entity = {
      ...
      // },
      // date_registered: "",
      description: "LerietMall-customer" // metadata: {},
      // default_card: "",

    };

    try {
      return await _mercadopago.default.customers.update(entity);
    } catch (err) {
  ...
  async deleteCustomer(entity, retries = 0) {
    ...
    try {
      return await _mercadopago.default.customers.remove(entity);
    } catch (err) {
  ...
  async createPreference(preference) {
    ...
    // };
    try {
      return await _mercadopago.default.preferences.create(preference);
    } catch (err) {
      const error = new Error(err.message);
      error.status = 500;
      throw error;
  ...
  async getPreference(entity) {
    ...
    try {
      return await _mercadopago.default.preferences.get(entity);
    } catch (err) {
      console.log(err);
      const error = new Error(err.message);
      error.status = 500;
  ...
  async updatePreference() {
    let entity = {
      id: "744446817-8c98d379-8c54-4a71-9a8c-238441d04cd7"
    };

    try {
      return await _mercadopago.default.preferences.update(entity);
    } catch (err) {
      console.log(err);
      const error = new Error(err.message);
      error.status = 500;
  ...
  async createOrder(preference) {
    ...
    try {
      return await _mercadopago.default.merchant_orders.create(order);
    } catch (err) {
      console.log(err);
      const error = new Error(err.message);
      error.status = 500;
  ...
  async getOrder(entity) {
    // const id = "2589485666";
    try {
      return await _mercadopago.default.merchant_orders.get(entity);
    } catch (err) {
      console.log(err);
      const error = new Error(err.message);
      error.status = 500;
  ...
  async updateOrder() {
    ...
    try {
      return await _mercadopago.default.merchant_orders.update(entity);
    } catch (err) {
      console.log(err);
      const error = new Error(err.message);
      error.status = 500;
  ...
  async getAllPayments(entity) {
    ...
    try {
      return await _mercadopago.default.payment.search(entity);
    } catch (err) {
      console.log(err);
      const error = new Error(err.message);
      error.status = 500;
  ...
  async getPayment(entity) {
    try {
      return await _mercadopago.default.payment.get(entity);
    } catch (err) {
      console.log(err);
      const error = new Error(err.message);
      error.status = 500;
  ...
  async updatePayment(payment, entity) {
    ...
    try {
      return await _mercadopago.default.payment.update(body);
    } catch (err) {
      console.log(err);
      const error = new Error(err.message);
      error.status = 500;
  ...
  async runPay(entity) {
    ...
    const _products = await _productService.getProductsById({
      ids
    });
    ...
    return _helpers.Payment.createPreference({
      items: _items,
      user: customerExists
    });
  } // async mercadoPago() {
...
let preference = {
  body: {
    ...
    items: [{
      ...
      currency_id: "PEN",
      description: "",
      picture_url: "https://storage.googleapis.com/lerietmall-302923/https://storage.googleapis.com/lerietmall-302923/600cb509428833000ebd7a37/products/5fc8789498a6164095b22def/10a925bd-1b31-4de0-8352-4966b61de870.jpeg",
      title: "RGB",
      quantity: 1,
      unit_price: 10
    }],
