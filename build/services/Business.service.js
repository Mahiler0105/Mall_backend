...
class BusinessService extends BaseService {
  ...
  async get(idBusiness) {
    ...
    const articles = await business.subCategories.reduce(async (obj, item) => {
      ...
      if (business.category === 'services') objResponse = { ...objResponse,
        products: await _servService.getBySubCategory(item, business._id),
        type: 'S'
      };else objResponse = { ...objResponse,
        products: await _productService.getBySubCategory(item, business._id),
        type: 'P'
      };
