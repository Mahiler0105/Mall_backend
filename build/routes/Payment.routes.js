...
module.exports = function ({
  ...
  const router = Router(); // router.get('/customers', PaymentController.getCustomers); // 😁
  ...
  router.post('/run/pay', PaymentController.runPay); // router.post('/run/orders', PaymentController.runOrder);
