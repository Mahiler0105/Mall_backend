...
module.exports = async (ruc) => rucHandler.operation(rucHandler.token).then(async token => rucHandler.operation(rucHandler.rucSave(ruc), token)) // .then(async (data) => rucHandler.result(data))
